...
export type GetDocumentContainerQueryQueryVariables = Exact<{
  id?: InputMaybe<Scalars['String']>;
}>;


export type GetDocumentContainerQueryQuery = { __typename?: 'Query', document?: { __typename?: 'DocumentFile', id: string } | null };
...
export const GetDocumentContainerQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetDocumentContainerQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<GetDocumentContainerQueryQuery, GetDocumentContainerQueryQueryVariables>;
